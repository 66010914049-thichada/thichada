...
<title>66010914049  ธิชาดา สีทอน </title><br>
...
<body>
<div class="container">
    <h1 class="text-center mb-4 text-primary">ฟอร์มรับข้อมูล - 66010914049 ธิชาดา สีทอน(น้ำตาล)</h1>
    ...
    if (isset($_POST['Submit'])) {
        ...
        $sql = "INSERT INTO register (r_id, r_name, r_phone, r_height, r_address, r_birthday, r_color, r_major) VALUES (NULL, '{$fullname}', '{$phone}','{$height}', '{$address}', '{$date}', '{$color}', '{$major}');";
